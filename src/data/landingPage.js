...
export const heroData = {
    brandName: "Ditz",
    tagline: "Turning ideas into scroll-stopping brands",
    headline: "Make your brand <br /> grow with creativities",
    subheadline: "The new game changer of creativity",
    ctaText: "Get Started"
};

export const problemsData = {
    title: "It's hard to grow if there's no creative strategy",
    items: [
        {
            text: "Your Brand Will Stuck",
